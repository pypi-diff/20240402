# Comparing `tmp/gio_importer-1.0.8.tar.gz` & `tmp/gio_importer-1.0.9.tar.gz`
...
### Comparing `gio_importer-1.0.8/gio_importer.egg-info/SOURCES.txt` & `gio_importer-1.0.9/gio_importer.egg-info/SOURCES.txt`
