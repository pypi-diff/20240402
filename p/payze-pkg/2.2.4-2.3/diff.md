# Comparing `tmp/payze-pkg-2.2.4.tar.gz` & `tmp/payze-pkg-2.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "payze-pkg-2.2.4.tar", last modified: Tue Apr  2 10:06:46 2024, max compression
+gzip compressed data, was "payze-pkg-2.3.tar", last modified: Tue Apr  2 07:41:14 2024, max compression
```

## Comparing `payze-pkg-2.2.4.tar` & `payze-pkg-2.3.tar`

### file list

```diff
@@ -1,35 +1,31 @@
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.400852 payze-pkg-2.2.4/
--rw-r--r--   0 muhammadali   (501) staff       (20)      330 2024-04-02 10:06:46.400762 payze-pkg-2.2.4/PKG-INFO
--rw-r--r--   0 muhammadali   (501) staff       (20)     1094 2024-04-02 08:20:07.000000 payze-pkg-2.2.4/README.md
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.395737 payze-pkg-2.2.4/payze/
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.396428 payze-pkg-2.2.4/payze/examples/
--rw-r--r--   0 muhammadali   (501) staff       (20)        0 2024-04-02 08:49:35.000000 payze-pkg-2.2.4/payze/examples/__init__.py
--rw-r--r--   0 muhammadali   (501) staff       (20)     1481 2024-04-02 10:04:51.000000 payze-pkg-2.2.4/payze/examples/fast_api.py
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.396864 payze-pkg-2.2.4/payze/payze/
--rw-r--r--   0 muhammadali   (501) staff       (20)       48 2024-04-02 06:11:05.000000 payze-pkg-2.2.4/payze/payze/__init__.py
--rw-r--r--   0 muhammadali   (501) staff       (20)     2025 2024-04-02 09:06:46.000000 payze-pkg-2.2.4/payze/payze/client.py
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.396990 payze-pkg-2.2.4/payze/payze/param/
--rw-r--r--   0 muhammadali   (501) staff       (20)      141 2024-04-02 06:10:24.000000 payze-pkg-2.2.4/payze/payze/param/__init__.py
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.397454 payze-pkg-2.2.4/payze/payze/param/ops/
--rw-r--r--   0 muhammadali   (501) staff       (20)       47 2024-03-30 20:13:36.000000 payze-pkg-2.2.4/payze/payze/param/ops/__init__.py
--rw-r--r--   0 muhammadali   (501) staff       (20)      407 2024-04-01 04:19:11.000000 payze-pkg-2.2.4/payze/payze/param/ops/client.py
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.398455 payze-pkg-2.2.4/payze/payze/param/request/
--rw-r--r--   0 muhammadali   (501) staff       (20)       76 2024-04-01 09:58:49.000000 payze-pkg-2.2.4/payze/payze/param/request/__init__.py
--rw-r--r--   0 muhammadali   (501) staff       (20)     5004 2024-04-02 08:16:21.000000 payze-pkg-2.2.4/payze/payze/param/request/base.py
--rw-r--r--   0 muhammadali   (501) staff       (20)      841 2024-04-02 08:38:13.000000 payze-pkg-2.2.4/payze/payze/param/request/just_pay.py
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.399276 payze-pkg-2.2.4/payze/payze/param/response/
--rw-r--r--   0 muhammadali   (501) staff       (20)       60 2024-04-01 04:06:00.000000 payze-pkg-2.2.4/payze/payze/param/response/__init__.py
--rw-r--r--   0 muhammadali   (501) staff       (20)     2147 2024-04-02 06:12:04.000000 payze-pkg-2.2.4/payze/payze/param/response/base.py
--rw-r--r--   0 muhammadali   (501) staff       (20)      200 2024-04-01 10:31:41.000000 payze-pkg-2.2.4/payze/payze/param/response/just_pay.py
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.399847 payze-pkg-2.2.4/payze/payze/param/webhook/
--rw-r--r--   0 muhammadali   (501) staff       (20)       80 2024-04-02 09:09:55.000000 payze-pkg-2.2.4/payze/payze/param/webhook/__init__.py
--rw-r--r--   0 muhammadali   (501) staff       (20)     3161 2024-04-02 09:59:54.000000 payze-pkg-2.2.4/payze/payze/param/webhook/base.py
--rw-r--r--   0 muhammadali   (501) staff       (20)     2214 2024-04-02 09:54:39.000000 payze-pkg-2.2.4/payze/payze/param/webhook/just_pay.py
-drwxr-xr-x   0 muhammadali   (501) staff       (20)        0 2024-04-02 10:06:46.400527 payze-pkg-2.2.4/payze/payze_pkg.egg-info/
--rw-r--r--   0 muhammadali   (501) staff       (20)      330 2024-04-02 10:06:46.000000 payze-pkg-2.2.4/payze/payze_pkg.egg-info/PKG-INFO
--rw-r--r--   0 muhammadali   (501) staff       (20)      751 2024-04-02 10:06:46.000000 payze-pkg-2.2.4/payze/payze_pkg.egg-info/SOURCES.txt
--rw-r--r--   0 muhammadali   (501) staff       (20)        1 2024-04-02 10:06:46.000000 payze-pkg-2.2.4/payze/payze_pkg.egg-info/dependency_links.txt
--rw-r--r--   0 muhammadali   (501) staff       (20)       47 2024-04-02 10:06:46.000000 payze-pkg-2.2.4/payze/payze_pkg.egg-info/requires.txt
--rw-r--r--   0 muhammadali   (501) staff       (20)       15 2024-04-02 10:06:46.000000 payze-pkg-2.2.4/payze/payze_pkg.egg-info/top_level.txt
--rw-r--r--   0 muhammadali   (501) staff       (20)      107 2024-04-02 10:06:46.401212 payze-pkg-2.2.4/setup.cfg
--rw-r--r--   0 muhammadali   (501) staff       (20)      537 2024-04-02 10:05:43.000000 payze-pkg-2.2.4/setup.py
...
### Comparing `payze-pkg-2.2.4/payze/payze/client.py` & `payze-pkg-2.3/payze/payze/client.py`
...
### Comparing `payze-pkg-2.2.4/payze/payze/param/request/base.py` & `payze-pkg-2.3/payze/payze/param/request/base.py`
...
### Comparing `payze-pkg-2.2.4/payze/payze/param/request/just_pay.py` & `payze-pkg-2.3/payze/payze/param/request/just_pay.py`
...
### Comparing `payze-pkg-2.2.4/payze/payze/param/response/base.py` & `payze-pkg-2.3/payze/payze/param/response/base.py`

 * *Files identical despite different names*

### Comparing `payze-pkg-2.2.4/payze/payze_pkg.egg-info/SOURCES.txt` & `payze-pkg-2.3/payze/payze_pkg.egg-info/SOURCES.txt`
...
@@ -1,24 +1,21 @@
 ...
 setup.cfg
 setup.py
-payze/examples/__init__.py
-payze/examples/fast_api.py
...
-payze/payze/param/webhook/base.py
...
### Comparing `payze-pkg-2.2.4/setup.py` & `payze-pkg-2.3/setup.py`
