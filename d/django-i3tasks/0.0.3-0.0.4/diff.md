# Comparing `tmp/django_i3tasks-0.0.3.tar.gz` & `tmp/django_i3tasks-0.0.4.tar.gz`
...
## Comparing `django_i3tasks-0.0.3.tar` & `django_i3tasks-0.0.4.tar`
...
### Comparing `django_i3tasks-0.0.3/LICENSE` & `django_i3tasks-0.0.4/LICENSE`

 * *Files identical despite different names*

### Comparing `django_i3tasks-0.0.3/django_i3tasks/models.py` & `django_i3tasks-0.0.4/django_i3tasks/models.py`

 * *Files identical despite different names*

### Comparing `django_i3tasks-0.0.3/django_i3tasks/types.py` & `django_i3tasks-0.0.4/django_i3tasks/types.py`

 * *Files identical despite different names*

### Comparing `django_i3tasks-0.0.3/django_i3tasks/urls.py` & `django_i3tasks-0.0.4/django_i3tasks/urls.py`

 * *Files identical despite different names*

### Comparing `django_i3tasks-0.0.3/django_i3tasks/utils.py` & `django_i3tasks-0.0.4/django_i3tasks/utils.py`

 * *Files identical despite different names*

### Comparing `django_i3tasks-0.0.3/django_i3tasks/views.py` & `django_i3tasks-0.0.4/django_i3tasks/views.py`

 * *Files identical despite different names*

### Comparing `django_i3tasks-0.0.3/setup.py` & `django_i3tasks-0.0.4/setup.py`
