# Comparing `tmp/feliz_db-0.0.4.tar.gz` & `tmp/feliz_db-0.0.6.tar.gz`
...
## Comparing `feliz_db-0.0.4.tar` & `feliz_db-0.0.6.tar`
...
### Comparing `feliz_db-0.0.4/LICENSE` & `feliz_db-0.0.6/LICENSE`

 * *Files identical despite different names*

### Comparing `feliz_db-0.0.4/PKG-INFO` & `feliz_db-0.0.6/PKG-INFO`
...
### Comparing `feliz_db-0.0.4/feliz_db/mongo_tools.py` & `feliz_db-0.0.6/feliz_db/mongo_tools.py`
...
### Comparing `feliz_db-0.0.4/feliz_db/postgres_tools.py` & `feliz_db-0.0.6/feliz_db/postgres_tools.py`
...
### Comparing `feliz_db-0.0.4/feliz_db.egg-info/PKG-INFO` & `feliz_db-0.0.6/feliz_db.egg-info/PKG-INFO`
...
### Comparing `feliz_db-0.0.4/setup.py` & `feliz_db-0.0.6/setup.py`
