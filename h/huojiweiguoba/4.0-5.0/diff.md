# Comparing `tmp/huojiweiguoba-4.0.tar.gz` & `tmp/huojiweiguoba-5.0.tar.gz`
...
## Comparing `huojiweiguoba-4.0.tar` & `huojiweiguoba-5.0.tar`
...
### Comparing `huojiweiguoba-4.0/LICENSE` & `huojiweiguoba-5.0/LICENSE`

 * *Files identical despite different names*

### Comparing `huojiweiguoba-4.0/huojiweiguoba/lbw_datetime.py` & `huojiweiguoba-5.0/huojiweiguoba/lbw_datetime.py`

 * *Files identical despite different names*

### Comparing `huojiweiguoba-4.0/huojiweiguoba/lbw_token.py` & `huojiweiguoba-5.0/huojiweiguoba/lbw_token.py`

 * *Files identical despite different names*

### Comparing `huojiweiguoba-4.0/huojiweiguoba/lbw_xbds.py` & `huojiweiguoba-5.0/huojiweiguoba/lbw_xbds.py`
...
### Comparing `huojiweiguoba-4.0/setup.py` & `huojiweiguoba-5.0/setup.py`
